...
import com.mycompany.school.domain.EventDataOnDemand;
...
privileged aspect EventDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    EventCategoryDataOnDemand EventDataOnDemand.eventCategoryDataOnDemand;
    
    @Autowired
    EventTypeDataOnDemand EventDataOnDemand.eventTypeDataOnDemand;
